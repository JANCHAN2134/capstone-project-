GLOSSARY = {
    ...
    "lowest": "ORDER BY ASC",
    # Predictive / Forecast
    "forecast": "strftime('%Y-%m', order_purchase_timestamp)",
    "predict": "strftime('%Y-%m', order_purchase_timestamp)",
    "trend": "strftime('%Y-%m', order_purchase_timestamp)",
    "next month": "strftime('%Y-%m', order_purchase_timestamp)",
    "next quarter": "strftime('%Y-%m', order_purchase_timestamp)",
    "growth": "SUM(price)",
    "projection": "strftime('%Y-%m', order_purchase_timestamp)",
}
